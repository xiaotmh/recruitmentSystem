	...
	<body>
            ...
            <span class="icon-bar"></span>
				...
				<div class="collapse navbar-collapse" id="example-navbar-collapse">
					...
					<ul class="nav navbar-nav navbar-right">
						<li>
							<a href="etuserlogin" style="color: #fff;"><span class="glyphicon glyphicon-log-in"></span> 登录</a>
						</li>
					</ul>
				</div>
			</div>
		...
		<div class="cenReg" id="reg">
			...
			<div class="cen3Reg">
				...
				<div class="tableReg">
					<form id="frm" action="etuserregister">
						<div class="row">
						...
						<div class="row">
							<div class="col-sm-6"> <img src="images/register-arrow.gif" style="margin-right: 10px;" />会员名:&nbsp;&nbsp;<input type="text" id="userName" style="width:150px;"  name="bid"/></div>
							<div class="col-sm-6">
								<a href="javascript:validateUserName()"><img src="images/register-check.gif" style="border:0px;" /></a>会员名须以字母开头，至少6位</div>
						</div>
						<div class="row">
							<div class="col-sm-6"> <img src="images/register-arrow.gif" style="margin-right: 10px;" name="epwd"/>密码:&nbsp;&nbsp;&nbsp;<input type="password" id="pwd1" onblur="validatePwd1()" style="width:150px" name="bpwd"/></div>
