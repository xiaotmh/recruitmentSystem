...
<div class="container">
	<div class=" row">
		...
		<div class="col-sm-3" style="border-right:1px dotted #d4d3d3;border-radius: 10px;">
			...
			<div id="pop0" class="div111Intro"><img src="images/register-arrow.gif" /><span class="span11InnerIntro">企业的回复</span></div>
			<img src="images/intro-left2.gif" onclick="pop2()" class="img1Intro" />
			<div id="pop21" class="div112Intro"><img src="images/intro-1.gif" align="middle" /><span class="span12InnerIntro"><a href="#point1" class="aIntro">企业编号</a></span></div>
			<div id="pop22" class="div112Intro"><img src="images/intro-1.gif" align="middle" /><span class="span12InnerIntro"><a href="#point2" class="aIntro">企业名称</a></span></div>
			<div id="pop23" class="div112Intro"><img src="images/intro-1.gif" align="middle" /><span class="span12InnerIntro"><a href="#point2" class="aIntro">企业回复</a></span></div>
			<div id="pop24" class="div112Intro"><img src="images/intro-1.gif" align="middle" /><span class="span12InnerIntro"><a href="#point2" class="aIntro">企业电话</a></span></div>
			<div id="pop25" class="div112Intro"><img src="images/intro-1.gif" align="middle" /><span class="span12InnerIntro">企业描述信息</span></div>
			<div id="pop26" class="div112Intro"><img src="images/intro-1.gif" align="middle" /><span class="span12InnerIntro">企业地址</span></div>
		...
		<div class="col-sm-9">
			...
			<form class="form-horizontal" role="form" id="form" action="userresume">
				<div class="div111Intro"><img src="images/register-arrow.gif" /><span class="span11InnerIntro"><a name="point1">企业对您的回复以及信息</a></span></div>
				<img src="images/border.JPG" class="img2Intro" />
				<div class="form-group">
					<label  class="col-sm-2 control-label"><span>*</span>企业id:</label>
					<div class="col-sm-3">
						<input type="text" class="form-control" required="required" maxlength="10"   value="<%=resumereply.getEnid()%>" readonly="readonly">
					</div>
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					<label  class="col-sm-2 control-label"><span>*</span>企业名称:</label>
					<div class="col-sm-3">
						<input type="text" class="form-control" required="required" maxlength="10"  value="<%=etuserDetail.getAddress()%>" readonly="readonly">
					</div>
				</div>
				<div class="form-group">
					<label  class="col-sm-2 control-label"><span>*</span>企业详述信息:</label>
					<div class="col-sm-8">
						<input type="text" class="form-control" required="required" maxlength="10"  value="<%=etuserDetail.getInformation()%>" readonly="readonly">
					</div>
				</div>
				<div class="form-group">
					<label  class="col-sm-2 control-label"><span>*</span>回复:</label>
					<div class="col-sm-3">
						<input type="text" class="form-control" required="required" maxlength="10"  value="恭喜您，你已被邀请面试。" readonly="readonly">
					</div>
				</div>
				<div class="form-group">
					<label  class="col-sm-2 control-label"><span>*</span>和企业进行联系:</label>
					<div class="col-sm-3">
						<p align="left"><a target="_blank" href="<%=etuserDetail.getContact()%>"><img border="0" src="http://wpa.qq.com/pa?p=2:12345678:41" alt="点击这里给我发消息" title="点击这里给我发消息" align="center" /></a></p>
					</div>
					<%--https://admin.qidian.qq.com/template/blue/mp/menu/qr-code-jump.html?linkType=0&env=ol&kfuin=2852165618&fid=64&key=95ea14d43fee9d03c24509a9edd2ee10&cate=1&type=16&ftype=1&_type=wpa&qidian=true--%>
				</div>
				<div class="form-group">
					<label  class="col-sm-2 control-label"><span>*</span>企业联系电话:</label>
					<div class="col-sm-3">
						<input type="text" class="form-control" required="required" maxlength="10"  value="<%=etuserDetail.getPhone()%>" readonly="readonly">
					</div>
				</div>
				<div class="form-group">
					<label  class="col-sm-2 control-label"><span>*</span>企业官方网站:</label>
					<a href="<%=etuserDetail.getWebsite()%>" style="text-decoration:none;" target="_blank">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="glyphicon glyphicon-log-in"></span> 跳转到企业官方网站:</a>


					<div class="col-sm-3" style="display: none;">

						<input type="text" class="form-control" required="required" maxlength="10"  value="<%=etuserDetail.getWebsite()%>" readonly="readonly">
					</div>
				</div>
				<div class="form-group">
					<div class="col-sm-offset-2 col-sm-10">
						<button type="submit" class="btn btn-success" onclick="window.location.href='overtoudi'" >我知道了</button>
					</div>
				</div>
			</form>
		</div>
