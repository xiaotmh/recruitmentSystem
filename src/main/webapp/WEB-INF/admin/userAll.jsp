...
<head>
    ...
    <%
    List<User> users  = (List<User>)request.getAttribute("lists");
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#addManager">
                                    <i class="mdi mdi-account-plus"></i>&nbsp;<strong>新增用户</strong>
                                </button>
                                <br>
                                <form  method="post">
                                    <table id="managerTable" class="table table-hover" >
                                        ...
                                        %>
                                        <tr class="warning">
                                            <td ><input class="text " value="<%=users.get(i).getUid() %>" id="a<%=i%>" style="width:60px;" readonly="true" ></td>
                                            <td ><input class="text " value="<%=users.get(i).getUpwd() %>"  id="b<%=i%>" style="width:80px;" ></td>
                                            <td>
                                                <button type="button" class="btn btn-warning" onclick="window.location.href='userupdate?uid='+$('#a<%=i%>').val()+ '&&upwd='+$('#b<%=i%>').val()" >提交修改</button>
                                                <button type="button" class="btn btn-danger" onclick="window.location.href='userdelete?uid=<%=users.get(i).getUid()%>'">删除</button>
                                            </td>
                                                <%
                                            }
                                        %>
                                    ...
                                    <ul class="gcs-pagination">
                                        ...
                                        <li><a href="alluser2?pageNum=1">首页</a></li>
                                        <%
                                            if(pageNum!=1){
                                        %>
                                        <li><a href="alluser2?pageNum=<%=pageNum-1%>">上一页</a></li>
                                        <%
                                            }
                                        %>
                                        <li><a href="alluser2?pageNum=<%=pageNum%>">当前页数:<%=pageNum%></a></li>
                                        <li><a href="#">总页数:<%=count%></a></li>
                                        <%
                                            if(pageNum!=count){
                                        %>
                                        <li><a href="alluser2?pageNum=<%=pageNum+1%>">下一页</a></li>
                                        <%
                                            }
                                        %>
                                        <li><a href="alluser2?pageNum=<%=count%>">>尾页</a></li>
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <form id="newManager" action="userinsert" method="post">
