...
<head>
    ...
    <%
    List<Etuser> users  = (List<Etuser>)request.getAttribute("lists");
    ...
    <div class="lyear-layout-container">
        ...
        <aside class="lyear-layout-sidebar">
            ...
            <div id="logo" class="sidebar-header">
                <a href="/adminlogin2"><h4><strong>Libaryv1.0 </strong></h4></a>
            </div>
            <div class="lyear-layout-sidebar-scroll">
                <nav class="sidebar-main">
                    <ul class="nav nav-drawer">
                        <li class="nav-item active"> <a href="main.jsp"><i class="mdi mdi-home"></i> 欢迎来到在线选盘后台管理系统</a> </li>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#addManager">
                                    <i class="mdi mdi-account-plus"></i>&nbsp;<strong>新增企业用户</strong>
                                </button>
                                <br>
                                <form  method="post">
                                    <table id="managerTable" class="table table-hover" >
                                        ...
                                        <tr class="warning">
                                            ...
                                            <td ><input class="text " value="<%=users.get(i).getBpwd() %>"  id="b<%=i%>" style="width:80px;" ></td>
                                            <td>
                                                <button type="button" class="btn btn-warning" onclick="window.location.href='etuserupdate?eid='+$('#a<%=i%>').val()+ '&&epwd='+$('#b<%=i%>').val()" >提交修改</button>
                                                <button type="button" class="btn btn-danger" onclick="window.location.href='etuserdelete?eid=<%=users.get(i).getBid()%>'">删除</button>
                                            </td>
                                                <%
                                            }
                                        %>
                                    ...
                                    <ul class="gcs-pagination">
                                        ...
                                        <li><a href="alletuser2?pageNum=1">首页</a></li>
                                        <%
                                            if(pageNum!=1){
                                        %>
                                        <li><a href="alletuser2?pageNum=<%=pageNum-1%>">上一页</a></li>
                                        <%
                                            }
                                        %>
                                        <li><a href="alletuser2?pageNum=<%=pageNum%>">当前页数:<%=pageNum%></a></li>
                                        <li><a href="#">总页数:<%=count%></a></li>
                                        <%
                                            if(pageNum!=count){
                                        %>
                                        <li><a href="alletuser2?pageNum=<%=pageNum+1%>">下一页</a></li>
                                        <%
                                            }
                                        %>
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                ...
                                                <h4 class="modal-title" id="exampleModalLabel"><i class="mdi mdi-account-plus"></i>&nbsp;<strong>新增企业用户</strong></h4>
                                            </div>
                                            <div class="modal-body">
                                                <form id="newManager" action="etuserinsert" method="post">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" name="epwd" >
                                                    </div>
