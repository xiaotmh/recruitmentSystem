...
<head>
    ...
    <%
    List<Resume> resume  = (List<Resume>)request.getAttribute("resume");
        ...
        <aside class="lyear-layout-sidebar">
            ...
            <div class="lyear-layout-sidebar-scroll">
                ...
                <div class="sidebar-footer">
                    <p class="copyright">Copyright &copy; 2019. </a> All rights reserved.</p>
                </div>
            </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#addManager">
                                    <i class="mdi mdi-account-plus"></i>&nbsp;<strong>新增简历</strong>
                                </button>
                                <br>
                                <form  method="post">
                                    <table id="managerTable" class="table table-hover" >
                                        ...
                                        %>
                                        <tr class="warning">
                                            <td ><input class="text " value="<%=resume.get(i).getUid() %>" name="uid"  id="a<%=i%>" style="width:60px;" ></td>
                                            <td ><input class="text " value="<%=resume.get(i).getUname() %>" name="uname" id="b<%=i%>" style="width:80px;" ></td>
                                            <td ><input class="text " value="<%=resume.get(i).getAdvantage() %>" name="advantage" id="c<%=i%>" style="width:40px;"></td>
                                            <td ><input class="text " value="<%=resume.get(i).getWantmoney() %>" name="wantmoney" id="d<%=i%>"    style="width:30px;"></td>
                                            <td ><input class="number" value="<%=resume.get(i).getStatus() %>" name="status"  id="e<%=i%>"  style="width:30px;"></td>
                                            <td ><input class="number" value="<%=resume.get(i).getEnid() %>" name="enid" id="f<%=i%>"  style="width:30px;"></td>
                                            <td>
                                                <button type="button" class="btn btn-warning" onclick="window.location.href='resumeupdate?uid=<%=resume.get(i).getUid() %>&&uname='+$('#b<%=i%>').val()+'&&advantage='+$('#c<%=i%>').val() +'&&wantmoney='+$('#d<%=i%>').val()+
                                                        '&&status='+$('#e<%=i%>').val()+'&&enid='+$('#f<%=i%>').val() " >提交修改</button>
                                                <button type="button" class="btn btn-danger" onclick="window.location.href='resumedelete?uid=<%=resume.get(i).getUid()%>'">删除</button>
                                            </td>
                                                <%
                                            }
                                        %>
                                    ...
                                    <ul class="gcs-pagination">
                                        ...
                                        <li><a href="allresume2?pageNum=1">首页</a></li>
                                        <%
                                            if(pageNum!=1){
                                        %>
                                        <li><a href="allresume2?pageNum=<%=pageNum-1%>">上一页</a></li>
                                        <%
                                            }
                                        %>
                                        <li><a href="allresume2?pageNum=<%=pageNum%>">当前页数:<%=pageNum%></a></li>
                                        <li><a href="#">总页数:<%=count%></a></li>
                                        <%
                                            if(pageNum!=count){
                                        %>
                                        <li><a href="allresume2?pageNum=<%=pageNum+1%>">下一页</a></li>
                                        <%
                                            }
                                        %>
                                        <li><a href="allresume2?pageNum=<%=count%>">>尾页</a></li>
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                ...
                                                <h4 class="modal-title" id="exampleModalLabel"><i class="mdi mdi-account-plus"></i>&nbsp;<strong>新增简历</strong></h4>
                                            </div>
                                            <div class="modal-body">
                                                <form id="newManager" action="userresume" method="post">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" name="wantmoney" >
                                                    </div>
                                                    <div class="form-group">
