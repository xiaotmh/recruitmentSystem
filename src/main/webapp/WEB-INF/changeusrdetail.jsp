...
<div class="container">
	<div class=" row">
		...
		<div class="col-sm-3" style="border-right:1px dotted #d4d3d3;border-radius: 10px;">
			...
			<div id="pop24" class="div112Intro"><img src="images/intro-1.gif" align="middle" /><span class="span12InnerIntro">邮箱</span></div>
			<div id="pop25" class="div112Intro"><img src="images/intro-1.gif" align="middle" /><span class="span12InnerIntro">电话</span></div>
		...
		<div class="col-sm-9">
			...
			<form class="form-horizontal" role="form" id="form" action="changeuserdetailnow" name="myfrom" >
				<div class="div111Intro"><img src="images/register-arrow.gif" /><span class="span11InnerIntro"><a name="point1">用户编号为<%=ud.getUid()%>的用户“<%=ud.getRealname()%>”的个人信息为</a></span></div>
				<img src="images/border.JPG" class="img2Intro" />
			<div class="form-group" style="display: none;">
					<label  class="col-sm-2 control-label"><span>*</span>账号id:</label>
					<div class="col-sm-5">
						<input type="text" class="form-control" required="required" maxlength="10" name="uid"  id="uid" value="<%=ud.getUid()%>" readonly="readonly">
					</div>
				</div>
				<%--uid, realname,age,gender,email,phone,qq,major,classname,edubackground--%>
				<div class="form-group">
					<label  class="col-sm-2 control-label"><span>*</span>真实姓名:</label>
					<div class="col-sm-5">
						<input type="text" class="form-control" required="required" maxlength="10" name="realname" id="realname" value="<%=ud.getRealname()%>">
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-5">
						<input type="text" class="form-control" required="required" maxlength="10" name="age" id="age" value="<%=ud.getAge()%>">
					</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-5">
						<input type="text" class="form-control" required="required" maxlength="10" name="gender" id="gender" value="<%=ud.getGender()%>">
					</div>
				</div>
                ...
                <div class="form-group" style="display: none;">
                    ...
                    <div class="col-sm-5">
                        <input type="number" class="form-control" required="required" maxlength="10" name="email" id="email" value="<%=ud.getEmail()%>">
                    </div>
                </div>
				...
				<div class="form-group">
					...
					<div class="col-sm-5">
						<input type="text" class="form-control" required="required" maxlength="20" name="phone" id="phone" value="<%=ud.getPhone()%>">
					</div>
				</div>
				<div class="form-group">
					<label  class="col-sm-2 control-label"><span>*</span>QQ:</label>
					<div class="col-sm-5">
						<input type="text" class="form-control" required="required" maxlength="20" name="qq" id="qq" value="<%=ud.getQq()%>">
					</div>
				</div>
				<div class="form-group">
					<label  class="col-sm-2 control-label"><span>*</span>专业:</label>
					<div class="col-sm-5">
						<input type="text" class="form-control" required="required" maxlength="20"  name="major" id="major" value="<%=ud.getMajor()%>">
					</div>
				</div>
				<div class="form-group">
					<label  class="col-sm-2 control-label"><span>*</span>班级名:</label>
					<div class="col-sm-5">
						<input type="text" class="form-control" required="required" maxlength="20" name="classname" id="classname" value="<%=ud.getClassname()%>">
					</div>
				</div>
				<div class="form-group">
					<label  class="col-sm-2 control-label"><span>*</span>教育背景:</label>
					<div class="col-sm-5">
						<input type="text" class="form-control" required="required" maxlength="20" name="edubackground" id="edubackground" value="<%=ud.getEdubackground()%>">
					</div>
				</div>
		...
		%>
		<div class="form-group">
			<label  class="col-sm-2 control-label"><span>*</span>错误！！！未获取到您的uid</label>
		</div>
		<%
			}
