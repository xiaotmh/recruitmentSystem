...
<head>
    ...
    <style type="text/css">
        ...
        .div133Sear {
            ...
            height: 24px;
            float: left;
            background-image: url(images/search-choice.gif);
        }
...
<div class="bodydwt">
    <div class="headdwt">
        <div class="headerleftdwt"><img src="images/logo.gif"/></div>
        <div class="headerrightdwt">
            <a href="login" name="pic"><img src="images/menu1-2.gif" class="imgheaderdwt"/></a>
            <a href="search" name="pic"><img src="images/menu2-2.gif" class="imgheaderdwt"/></a>
            <a href="intro" name="pic"><img src="images/menu3-2.gif" class="imgheaderdwt"/></a>
        </div>
    </div>
    ...
    <div class="div1Sear" id="id0">
        ...
        <div class="div13Sear" id="id2">
            <span class="span1Sear"><img class="img1Sear" src="images/register-arrow.gif"/>关键字搜索</span>
            <form action="">
                <table>
            <div class="div131Sear">
                <input type="text" style="width:380px; border:1px solid #999; height:18px; background-image:url(images/key_search.gif); background-repeat:no-repeat; padding-left:20px" id="work"/>
                <input class="btn1Sear" id="btn" type="button"   value="职业名称"/>
            </div>
                    <br>
                     <center>
                    <button type="button" class="btn btn-success"  onclick="window.location.href='bywork?work='+$('#work').val()">开始搜索</button> 　
                     </center>
                </table>
            </form>
　
            ...
            <div class="popupDiv1Sear1" id="popup1">
                <div class="popupmenuDiv1Sear1">
                    <img src="images/orangearrow.gif" align="middle"/><span
                        class="spanpopupmenuDiv1Sear">请选择您想搜索的职位</span>
                    <span class="spanrightpopupmenuDiv1Sear1"><span class="spanright1popupmenuDiv1Sear"
                                                                    onclick="selectList1()">[确定]</span><span
                            class="spanright2popupmenuDiv1Sear" onclick="cancelList1()">[关闭]</span></span>
                </div>
            ...
            <div class="popupDiv2Sear" id="popup2">
                <div class="popupmenuDiv1Sear">
                    <img src="images/orangearrow.gif" align="middle"/><span
                        class="spanpopupmenuDiv1Sear">请选择您想搜索的行业</span>
                    <span class="spanrightpopupmenuDiv1Sear"><span class="spanright1popupmenuDiv1Sear"
                                                                   onclick="selectList2()">[确定]</span><span
                            class="spanright2popupmenuDiv1Sear" onclick="cancelList2()">[关闭]</span></span>
                </div>
        ...
        <div class="provinceSelectSear" id="prov">
            <div class="proDiv1Sear">
                <img src="images/orangearrow.gif" align="middle"/><span class="spanpopupmenuDiv1Sear">请选择工作地点</span>
                <span class="spanrightpopupmenuDiv1Sear1"><span class="spanright2popupmenuDiv1Sear"
                                                                onclick="changeContent(0)">[关闭]</span></span>
            </div>
            <div>
...
<div class="divdwt">
    网站导航&nbsp;&nbsp;|&nbsp;&nbsp;<a href="main" class="adwt">网站首页</a>&nbsp;&nbsp;|&nbsp;&nbsp;<a
        href="search" class="adwt">职位搜索</a>&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;<a
        href="register" class="adwt">用户注册</a>&nbsp;&nbsp;|&nbsp;&nbsp;<a href="userlogin" class="adwt">用户登录</a>&nbsp;&nbsp;|&nbsp;&nbsp;<a
        href="loading" class="adwt">简历管理</a>&nbsp;
</div>
<div>
    ...
    <span class="spandwt"><a href="main"><img src="images/bottom1.gif" class="imgdwt"/></a></span>
</div>
...
<script type="text/javascript">
    ...
    popup1.style.left = (document.body.clientWidth - 570) / 2;
    ...
    var boxes = document.getElementsByName("list");//可用的全部checkbox数组
    ...
    pics[1].innerHTML = "<img src='images/menu2-1.gif' class='imgheaderdwt' />";
