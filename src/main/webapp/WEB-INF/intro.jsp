...
<div class="container">
	<div class=" row">
		...
		<%
			Resume resume= (Resume) session.getAttribute("overresume");
			Rcmessage rcmessage= (Rcmessage) session.getAttribute("Rcmessage");
			String uid=request.getSession().getAttribute("userid").toString();
			String enid=request.getSession().getAttribute("targetenid").toString();
			UserDetail userdetailtemp=(UserDetail)request.getSession().getAttribute("userdetail");
			if(resume!=null){
		%>
		...
		<div class="col-sm-9">
			...
			<form class="form-horizontal" role="form" id="form" action="userresume">
				...
				<div class="form-group">
					...
					<div class="col-sm-3">
						<input type="text" class="form-control" required="required" maxlength="10" name="uid"  value="<%=resume.getUid()%>" >
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-3">
						<input type="text" class="form-control" required="required" maxlength="10" name="uname" value="<%=resume.getUname()%>">
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-8">
						<input type="text" class="form-control" required="required" maxlength="10" name="advantage" value="<%=resume.getAdvantage()%>">
					</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-3">
						<input type="number" class="form-control" required="required" maxlength="10" name="wantmoney" value="<%=resume.getWantmoney()%>">
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-3">
						<input type="number" class="form-control" required="required" maxlength="10" name="enid" value="<%=rcmessage.getEnid()%>">
					</div>
				</div>
				<div class="form-group">
					<div class="col-sm-offset-2 col-sm-10">
						<button type="submit" class="btn btn-warning">投递</button>
		...
		<div class="col-sm-9">
			...
			<form class="form-horizontal" role="form" action="userresume">
				...
				<div class="form-group">
					<label  class="col-sm-2 control-label"><span>*</span>姓名:</label>
					<div class="col-sm-3">
						<input type="text" class="form-control" required="required" maxlength="10"  value="<%=userdetailtemp.getRealname()%>" name="uname"  readonly="readonly" >
					</div>
				</div>
				...
				<div class="form-group">
					<label class="col-sm-2 control-label"><span>*</span>自身优势:</label>
					<div class="col-sm-8">
						<textarea class="form-control" required="required" maxlength="1000" name="advantage" ></textarea>
					</div>
				...
				<div class="form-group">
					<label  class="col-sm-2 control-label"><span>*</span>期望薪资:</label>
					<div class="col-sm-3">
						<input type="number" class="form-control" required="required" maxlength="10" name="wantmoney" value="">
					</div>
				</div>
				<%
					if(enid!="")//rcmessage.getEnid()!=null)
					{
				...
				<div class="form-group">
					<label  class="col-sm-2 control-label"><span>*</span>所投企业编号:</label>
					<div class="col-sm-3">
						<input type="number" class="form-control" required="required" maxlength="10" name="enid" value="<%=enid%>"  readonly="readonly">
					</div>
				</div>
				<%
					}
				...
				<div class="form-group">
					<label  class="col-sm-2 control-label"><span>*</span>所投企业编号:</label>
					<div class="col-sm-3">
						<input type="number" class="form-control" required="required" maxlength="10" name="enid" value="未知">
					</div>
				</div>
				<%
					}
				...
				<div class="form-group">
					<div class="col-sm-offset-2 col-sm-10">
						<button type="submit" class="btn btn-warning">投递</button>
						<%--<button type="button" class="btn btn-default" onclick="window.location.href='caogao'">存为草稿</button>--%>
					</div>
				</div>
			</form>
		</div>
