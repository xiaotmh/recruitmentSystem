...
%>
                    <li>
                        <a href="userlogin" ><span class="glyphicon glyphicon-user" style="color: #fff;">&nbsp;登录</span></a>
                    </li>
                    <li class="divider"></li>
                    <li>
                        <a href="register" ><span class="glyphicon glyphicon-circle-arrow-right" style="color: #fff;">&nbsp;注册</span></a>
                    </li>
        ...
        <div class=" ">
            <div class="col-sm-9">
                    ...
                    <dd>
                        ...
                        <dl>
                            ...
                            <dd>
                                ...
                                <a href="javascript:Work('云计算')">云计算</a>
                        ...
                        <dt>热门标签：</dt>
                        <dd>
                            <a href="javascript:Tag('年底双薪')">年底双薪</a>
                            <a href="javascript:Tag('专项奖金')">专项奖金</a>
                            <a href="javascript:Tag('股票期权')">股票期权</a>
                            <a href="javascript:Tag('绩效奖金')">绩效奖金</a>
                            <a href="javascript:Tag('年终分红')">年终分红</a>
                            <a href="javascript:Tag('带薪年假')">带薪年假</a>
                            <a href="javascript:Tag('交通补助')">交通补助</a>
                            <a href="javascript:Tag('通讯津贴')">通讯津贴</a>
                            <a href="javascript:Tag('午餐补助')">午餐补助</a>
                            <a href="javascript:Tag('定期体检')">定期体检</a>
                            <a href="javascript:Tag('弹性工作')">弹性工作</a>
                            <a href="javascript:Tag('年度旅游')">年度旅游</a>
                            <a href="javascript:Tag('节日礼物')">节日礼物</a>
                            <a href="javascript:Tag('免费班车')">免费班车</a>
                            <a href="javascript:Tag('领导好<')">领导好</a>
                            <a href="javascript:Tag('扁平管理')">扁平管理</a>
                ...
                <table class="table table-striped">
                    ...
                    <tbody>
                    <%
                        ArrayList<Rcmessage> list = (ArrayList<Rcmessage>) request.getAttribute("lists");
                    ...
                    <tr>
                        ...
                        <td>
                            <%=rcmessage.getWorkaddress()%>
                        </td>
                        <td>
                            <%=rcmessage.getMoremessage()%>
                        </td>
                        <td><%=rcmessage.getEducation()%>
                       <%
                        ...
                        <td>
                            <button class="btn btn-primary"
                                    onclick="window.location.href='usercollection?rmid=<%=rmid%>'" style="background-color: #ea934b">收藏
                            </button>
                            <button class="btn btn-warning"
                                    onclick="window.location.href='rcmessagemore?rmid=<%=rmid%>'" style="background-color: #ea934b">查询详情
                            </button>
                        </td>
                    </tr>
                    <%
                ...
                <ul class="gcs-pagination">
                    ...
                    <li><a href="rcmessagelogin?pageNum=1">首页</a></li>
                    <%
                        if(pageNum!=1){
                    %>
                    <li><a href="rcmessagelogin?pageNum=<%=pageNum-1%>">上一页</a></li>
                    <%
                        }
                    %>
                    <li><a href="rcmessagelogin?pageNum=<%=pageNum%>">当前页数:<%=pageNum%></a></li>
                    <li><a href="#">总页数:<%=count%></a></li>
                    <%
                        if(pageNum!=count){
                    %>
                    <li><a href="rcmessagelogin?pageNum=<%=pageNum+1%>">下一页</a></li>
                    <%
                        }
                    %>
                    <li><a href="rcmessagelogin?pageNum=<%=count%>">>尾页</a></li>
