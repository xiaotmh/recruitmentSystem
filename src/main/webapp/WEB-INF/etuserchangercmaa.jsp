...
<html xmlns:wb="http://open.weibo.com/wb">
	...
	<head>
		...
		<title>修改职位-招聘服务-拉勾网-最专业的互联网招聘平台</title>
				...
				<div class="col-sm-9">
					...
					<dl class="company_center_content">
						...
						<dd>
							...
							%>
							<form action="/etuserchangercmact" method="post" id="jobForm">
								...
								<table class="btm">
									...
									<tr>
										...
										<td>企业编号</td>
										<td>
											<input type="hidden" value="<%=rcmessage.getRmid()%>" name="rmid" id="rmid">
											<input type="text"  name="enid" readonly="readonly" value="<%=rcmessage.getEnid()%>">
										</td>
									</tr>
									<%
										}else{
									...
									<tr>
										...
										<td>
											<input type="hidden" value="<%=rcmessage.getRmid()%>" name="rmid" id="rmid">
											<input type="text"  name="enid" readonly="readonly" value="<%=rcmessage.getEnid()%>" placeholder="请输入登陆账号">
										</td>
									</tr>
									<%
										}
									...
									<tr>
										...
										<td>企业名称</td>
										<td>
											<input type="text" placeholder="请输入企业名称，如：腾讯"  value="<%=rcmessage.getEnname()%>"  name="enname">
										</td>
									</tr>
										<tr>
											...
											<td width="85">职位类别</td>
											<td>
												<input type="text"placeholder="请输入您要发布的职位名称"  value="<%=rcmessage.getWtype()%>"  name="wtype">
								...
								<table class="btm">
									<tbody>
										<tr>
											...
											<td width="85">工作性质</td>
											<td>
												<input type="text" placeholder=""  value="<%=rcmessage.getWork()%>"  name="work">
											</td>
										</tr>
										<tr>
											<td><span class="redstar">*</span></td>
											...
											<td>
												<div class="salary_range">
													<div>
														<input type="text" placeholder="最低月薪" value="<%=rcmessage.getMinmoney()%>" id="salaryMin" name="minmoney">
														<span>k</span>
													</div>
													<div>
														<input type="text" placeholder="最高月薪" value="<%=rcmessage.getMaxmoney()%>" id="salaryMax" name="maxmoney">
														<span>k</span>
													</div>
												</div>
											</td>
										...
										<tr>
											...
											<td>工作城市</td>
											<td>
												<input type="text" placeholder="请输入工作城市，如：北京" value="<%=rcmessage.getWorkcity()%>" name="workcity" >
											</td>
										</tr>
									</tbody>
								</table>
									...
									<tbody>
										<tr>
											...
											<td>
												...
												<input type="text" placeholder="请输入工作经验" value="<%=rcmessage.getExperience()%>" name="experience" id="experience">
										...
										<tr>
											...
											<td>
												...
												<input type="text" placeholder="请输入学历要求" value="<%=rcmessage.getEducation()%>" name="education" id="education">
										...
										<tr>
											...
											<td>
												...
												<input type="text" name="moremessage" id="moremessage"  value="<%=rcmessage.getMoremessage()%>" ></input>
										...
										<tr>
											<td>工作地址</td>
											<td>
												<input type="text" placeholder="请输入详细的工作地址" value="<%=rcmessage.getWorkaddress()%>" name="workaddress" class="input_520" id="positionAddress">
								...
								<table>
									<tbody>
										...
										<tr>
											<td width="25"></td>
											<td colspan="2">
												<input type="submit" value="修改！" id="formSubmit" class="btn_32">
											</td>
										</tr>
									</tbody>
								</table>
