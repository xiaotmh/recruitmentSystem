    ...
    <div class="container">
        ...
        <div class="col-sm-9">
            ...
            <!--修改密码部分开始-->
                ...
                <br/>
            <br/>
                    <form class="" role="form" method="get" action="/changeusrpwdnow">
                            ...
                            <div class="col-sm-5" style="height: 60px">
                                <label for="uid" class="control-label" style="font-size: larger;" >您当前登录用户为 &nbsp </label>
                            </div>
                            <div class="col-sm-4" style="height: 60px">

                                <input type="text" class="form-control col-sm-4" id="uid" name="uid" style="width: 250px;margin-top: 0px;"   value="<%=request.getSession().getAttribute("userid")%>" readonly="readonly">
                            </div>
                            <div class="col-sm-5" style="height: 60px">
                            <label for="upwd" class="control-label" style="font-size: larger;" >请输入旧的密码</label>
                            </div>
                            <div class="col-sm-4" style="height: 60px">

                                <input type="password" class="form-control col-sm-4" id="upwd" name="upwd"  style="width: 250px; margin-top: 0px;"  placeholder="请输入密码">
                            </div>
                            <div class="col-sm-5" style="height: 60px">
                            <label for="newupwd" class="control-label" style="font-size: larger;" >请输入新的密码</label>
                            </div>
                            <div class="col-sm-4" style="height: 60px">

                                <input type="password" class="form-control col-sm-4" id="newupwd" style="width: 250px; margin-top: 0px;"  name="newupwd" placeholder="请输入密码">
                            </div>
                            <div class="col-sm-offset-2 col-lg-2">
                                <button  class="btn btn-default" onclick="window.location.href='userupdate2?uid='+$('#uid').val()+ '&&upwdold='+$('#inputOldPassword').val()+ '&&upwdnew='+$('#inputNewPassword').val()">修改</button>

                            </div>
                    </form>
            <div class="col-sm-offset-2 col-lg-2">
                <button  class="btn btn-default"  onclick="javascript:window.location.href='rcmessagelogin'">返回</button>
            </div>
                    　<%--///////////////////////////////////////////////////--%>
