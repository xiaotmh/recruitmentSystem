...
<div class="container">
	<div class=" row">
		...
		<div class="col-sm-3" style="border-right:1px dotted #d4d3d3;border-radius: 10px;">
			...
			<div id="pop21" class="div112Intro"><img src="images/intro-1.gif" align="middle" /><span class="span12InnerIntro">基本企业信息</span></div>

			<div id="pop23" class="div112Intro"><img src="images/intro-1.gif" align="middle" /><span class="span12InnerIntro">企业名</span></div>
			<div id="pop24" class="div112Intro"><img src="images/intro-1.gif" align="middle" /><span class="span12InnerIntro">企业联系地址</span></div>
			<div id="pop25" class="div112Intro"><img src="images/intro-1.gif" align="middle" /><span class="span12InnerIntro">企业联系电话</span></div>
			<div id="pop26" class="div112Intro"><img src="images/intro-1.gif" align="middle" /><span class="span12InnerIntro">企业官网</span></div>
			<div id="pop22" class="div112Intro"><img src="images/intro-1.gif" align="middle" /><span class="span12InnerIntro">企业详细信息</span></div>
			<div id="pop22" class="div112Intro"><img src="images/intro-1.gif" align="middle" /><span class="span12InnerIntro">企业沟通url</span></div>
		</div>
		<!--中间内容左边结束-->
		<!--中间内容右边开始-->
		...
		<%
			...
			EtuserDetail eud=(EtuserDetail) session.getAttribute("etuserdetail");
			if(eud!=null){
			System.out.println("前台页面eud不为空");
		%>
		<div class="col-sm-9">

			<form class="form-horizontal" role="form" id="form" action="changeetuserdetailnow" name="myfrom" method="post">
				<div class="div111Intro"><img src="images/register-arrow.gif" /><span class="span11InnerIntro"><a name="point1">企业编号：“<%=eud.getBid()%>”的企业：“<%=eud.getRealname()%>”的个人信息为</a></span></div>
				<img src="images/border.JPG" class="img2Intro" />
				<div class="form-group" style="display: none;">
					<label  class="col-sm-2 control-label"><span>*</span>账号id:</label>
					<div class="col-sm-5">
						<input type="text" class="form-control" required="required" maxlength="10" name="bid"  id="bid" value="<%=eud.getBid()%>" readonly="readonly">
					</div>
				</div>
				<%--uid, realname,age,gender,email,phone,qq,major,classname,edubackground--%>
				<div class="form-group">
					<label  class="col-sm-2 control-label"><span>*</span>企业名:</label>
					<div class="col-sm-5">
						<input type="text" class="form-control" required="required" maxlength="10" name="realname" id="realname" value="<%=eud.getRealname()%>">
					</div>
				</div>

				<div class="form-group">
					<label class="col-sm-2 control-label"><span>*</span>企业地址:</label>
					<div class="col-sm-5">
						<input type="text" class="form-control" required="required" maxlength="10" name="address" id="address" value="<%=eud.getAddress()%>">
					</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-5">
						<input type="text" class="form-control" required="required" maxlength="10" name="phone" id="phone" value="<%=eud.getPhone()%>">
					</div>
				</div>

				<div class="form-group" style="display: none;">
					<label  class="col-sm-2 control-label"><span>*</span>企业网站：</label>
					<div class="col-sm-5">
						<input type="text" class="form-control" required="required" maxlength="10" name="website" id="website" value="<%=eud.getWebsite()%>">
					</div>
				</div>
				...
				<div class="form-group">
					<label  class="col-sm-2 control-label"><span>*</span>企业具体描述信息:</label>
					<div class="col-sm-5">
						<input type="text" class="form-control" required="required" maxlength="20" name="information" id="information" value="<%=eud.getInformation()%>">
					</div>
				</div>

				<div class="form-group">
					<label  class="col-sm-2 control-label"><span>*</span>企业沟通链接:</label>
					<div class="col-sm-5">
						<input type="text" class="form-control" required="required" maxlength="20" name="contact" id="contact" value="<%=eud.getContact()%>">
					</div>
				</div>
		...
		%>
		<div class="form-group">
			<label  class="col-sm-2 control-label"><span>*</span>错误！！！未获取到您的enid</label>
		</div>
		<%
			}
